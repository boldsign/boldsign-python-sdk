...
with boldsign.ApiClient(configuration) as api_client:
    ...
    hide_reassign = False # bool | Enabling this option disables reassignment for all new documents. This setting cannot be changed during document creation. (optional) (default to False)
