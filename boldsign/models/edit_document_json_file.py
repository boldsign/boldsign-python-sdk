...
class EditDocumentJsonFile(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "file": Base64File.from_dict(obj["file"]) if obj.get("file") is not None else None,
