...
class TemplateEvent(BaseModel):
    ...
    form_field_permission: Optional[FormFieldPermissionWebhookModel] = Field(default=None, alias="formFieldPermission")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "formFieldPermission": FormFieldPermissionWebhookModel.from_dict(obj["formFieldPermission"]) if obj.get("formFieldPermission") is not None else None,
    ...
    def openapi_types(cls) -> Dict[str, str]:
        return {
            ...
            "form_field_permission": "(FormFieldPermissionWebhookModel,)",
