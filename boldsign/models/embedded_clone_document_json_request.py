...
class EmbeddedCloneDocumentJsonRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["redirectUrl", "viewOption", "showSaveButton", "showPreviewButton", "showNavigationButtons", "linkValidTill", "includeFormFieldValues", "locale", "showSendButton", "showToolbar", "showTooltip", "onBehalfOf"]
