...
class KbaSettings(BaseModel):
    """
    KbaSettings
    """ # noqa: E501
    type: Optional[StrictStr] = None
    maximum_retry_count: Optional[Annotated[int, Field(le=3, strict=True, ge=1)]] = Field(default=None, alias="maximumRetryCount")
    name_matcher: Optional[StrictStr] = Field(default=None, alias="nameMatcher")
    __properties: ClassVar[List[str]] = ["type", "maximumRetryCount", "nameMatcher"]
    ...
    def name_matcher_validate_enum(cls, value):
        ...
        if value not in set(['None', 'Lenient', 'Moderate', 'Strict']):
            raise ValueError("must be one of enum values ('None', 'Lenient', 'Moderate', 'Strict')")
        return value
