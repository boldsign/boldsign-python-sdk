...
class TemplateTeamShareRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["teamId", "action", "accessLevel"]

    @field_validator('action')
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Grant', 'Revoke']):
            raise ValueError("must be one of enum values ('Grant', 'Revoke')")
        return value
