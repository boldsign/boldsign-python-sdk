...
class SenderIdentityEvent(BaseModel):
    ...
    created_by: Optional[SenderIdentityCreator] = Field(default=None, alias="createdBy")
    locale: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["object", "id", "name", "email", "status", "createdDate", "modifiedDate", "approvedDateTime", "brandId", "redirectUrl", "metaData", "createdBy", "locale"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "createdBy": SenderIdentityCreator.from_dict(obj["createdBy"]) if obj.get("createdBy") is not None else None,
    ...
    def openapi_types(cls) -> Dict[str, str]:
        return {
            ...
            "created_by": "(SenderIdentityCreator,)",
            "locale": "(str,)",
        }
