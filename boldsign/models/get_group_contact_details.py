...
class GetGroupContactDetails(BaseModel):
    """
    ...
    contacts: Optional[List[GroupUser]] = None
    creator: Optional[Creators] = None
    directories: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["groupName", "groupId", "contacts", "creator", "directories"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contacts": [GroupUser.from_dict(_item) for _item in obj["contacts"]] if obj.get("contacts") is not None else None,
            "creator": Creators.from_dict(obj["creator"]) if obj.get("creator") is not None else None,
