...
class DocumentSignerWebhookModel(BaseModel):
    ...
    group_signers: Optional[List[DocumentGroupSignerWebhookModel]] = Field(default=None, alias="groupSigners")
    ...
    id_verification: Optional[IdVerificationSignerWebhookModel] = Field(default=None, alias="idVerification")
    kba: Optional[KbaSignerWebhookModel] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "groupSigners": [DocumentGroupSignerWebhookModel.from_dict(_item) for _item in obj["groupSigners"]] if obj.get("groupSigners") is not None else None,
            ...
            "idVerification": IdVerificationSignerWebhookModel.from_dict(obj["idVerification"]) if obj.get("idVerification") is not None else None,
            "kba": KbaSignerWebhookModel.from_dict(obj["kba"]) if obj.get("kba") is not None else None,
            ...
            "authenticationSettings": SignerAuthenticationWebhookModel.from_dict(obj["authenticationSettings"]) if obj.get("authenticationSettings") is not None else None
        })
        return _obj
    ...
    def openapi_types(cls) -> Dict[str, str]:
        return {
            ...
            "signer_email": "(str,)",
            "id": "(str,)",
            "group_signers": "(List[DocumentGroupSignerWebhookModel],)",
