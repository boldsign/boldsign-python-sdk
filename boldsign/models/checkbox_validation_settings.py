...
class CheckboxValidationSettings(BaseModel):
    """
    CheckboxValidationSettings
    """ # noqa: E501
    validation_type: Optional[StrictStr] = Field(default=None, alias="validationType")
    min_selection: Optional[StrictInt] = Field(default=None, alias="minSelection")
    max_selection: Optional[StrictInt] = Field(default=None, alias="maxSelection")
    __properties: ClassVar[List[str]] = ["validationType", "minSelection", "maxSelection"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "minSelection": obj.get("minSelection"),
            "maxSelection": obj.get("maxSelection")
        })
        return _obj
