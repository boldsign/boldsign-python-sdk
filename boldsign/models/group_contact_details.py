...
class GroupContactDetails(BaseModel):
    """
    GroupContactDetails
    """ # noqa: E501
    group_name: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="groupName")
    contacts: List[GroupUser]
    directories: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["groupName", "contacts", "directories"]
