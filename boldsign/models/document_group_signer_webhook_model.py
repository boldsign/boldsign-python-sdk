...
class DocumentGroupSignerWebhookModel(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "signerEmail", "signerName", "status", "isViewed", "isDeliveryFailed", "isAuthenticationFailed", "lastReminderSentOn"]
