...
class EmbeddedDocumentEditJsonRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["redirectUrl", "showToolbar", "sendViewOption", "locale", "showSendButton", "showPreviewButton", "showNavigationButtons", "linkValidTill", "onBehalfOf"]
