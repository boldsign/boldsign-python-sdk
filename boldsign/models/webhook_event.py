...
class WebhookEvent(BaseModel):
    ...
    data: Optional[IWebhookData] = None
    document: Optional[DocumentEvent] = None
    __properties: ClassVar[List[str]] = ["event", "context", "data", "document"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "context": WebhookContext.from_dict(obj["context"]) if obj.get("context") is not None else None,
            "data": IWebhookData.from_dict(obj["data"]) if obj.get("data") is not None else None,
