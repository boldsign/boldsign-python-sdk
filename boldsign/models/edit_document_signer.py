...
class EditDocumentSigner(BaseModel):
    """
    EditDocumentSigner
    """ # noqa: E501
    ...
    form_fields: Optional[List[EditFormField]] = Field(default=None, alias="formFields")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "formFields": [EditFormField.from_dict(_item) for _item in obj["formFields"]] if obj.get("formFields") is not None else None,
    ...
    def openapi_types(cls) -> Dict[str, str]:
        return {
            ...
            "form_fields": "(List[EditFormField],)",
            "language": "(int,)",
            "locale": "(str,)",
            "sign_type": "(str,)",
            "group_id": "(str,)",
