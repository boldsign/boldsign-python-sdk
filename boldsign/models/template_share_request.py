...
class TemplateShareRequest(BaseModel):
    ...
    """ # noqa: E501
    teams: Optional[List[TemplateTeamShareRequest]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "teams": [TemplateTeamShareRequest.from_dict(_item) for _item in obj["teams"]] if obj.get("teams") is not None else None
        })
        return _obj
    ...
    def openapi_types(cls) -> Dict[str, str]:
        return {
            "teams": "(List[TemplateTeamShareRequest],)",
        }
