...
class EmbeddedCloneTemplateJsonRequest(BaseModel):
    """
    ...
    include_form_field_values: Optional[StrictBool] = Field(default=False, alias="includeFormFieldValues")
    ...
    __properties: ClassVar[List[str]] = ["redirectUrl", "viewOption", "showSaveButton", "showPreviewButton", "showNavigationButtons", "linkValidTill", "includeFormFieldValues", "locale", "showCreateButton", "showToolbar", "showTooltip", "onBehalfOf"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "includeFormFieldValues": obj.get("includeFormFieldValues") if obj.get("includeFormFieldValues") is not None else False,
    ...
    def openapi_types(cls) -> Dict[str, str]:
        return {
            ...
            "include_form_field_values": "(bool,)",
            "locale": "(str,)",
