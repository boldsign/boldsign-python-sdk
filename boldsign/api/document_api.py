...
class DocumentApi:
    ...
    def cancel_editing(
        ...
        _param = self._cancel_editing_serialize(
            document_id=document_id,
    ...
    def _cancel_editing_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/document/cancelEditing',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def create_embedded_edit_url(
        ...
        _param = self._create_embedded_edit_url_serialize(
            document_id=document_id,
            embedded_document_edit_json_request=embedded_document_edit_json_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def create_embedded_edit_url_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EmbeddedDocumentEdited]:
        """Generates an embedded edit URL that allows the document editing process to be integrated into your application.
    ...
    def _create_embedded_edit_url_serialize(
        self,
        document_id,
        ...
        has_files = False
        body_param = embedded_document_edit_json_request
        excluded_json_fields = set([])
        # Check if body_param is a list of models
        if isinstance(body_param, list):
            for item in body_param:
        ...
        # process the form parameters
        # process the body parameter
        if embedded_document_edit_json_request is not None and has_files is False:
            _body_params = embedded_document_edit_json_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/document/createEmbeddedEditUrl',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _edit_document_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/v1/document/edit',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
